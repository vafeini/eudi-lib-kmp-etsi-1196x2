...
/**
 * DER test certificates for the iOS end-to-end factory test (validity 2020-2099).
 * ROOT is a self-signed CA; LEAF is an end-entity signed by ROOT.
 * Mirrors the fixtures in the consultation module's iosTest.
 */
internal object E2eTestCerts {

    val rootDer: ByteArray get() = Base64.decode(ROOT)
    val leafDer: ByteArray get() = Base64.decode(LEAF)
